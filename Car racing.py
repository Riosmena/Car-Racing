...
class Lineas(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image=pygame.image.load("assets/lineas.png").convert()
...
class Jugador(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image=pygame.image.load("assets/Carro verde.png").convert()
...
class Enemigos(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image=pygame.image.load("assets/Carro naranja.png").convert()
        self.image.set_colorkey(Blanco)
        self.rect=self.image.get_rect()
    def update(self):
...
for i in range(5):
    ...
    autos.add(auto)
    todo.add(auto)
pygame.mixer.music.load("music/NRX.mp3")
